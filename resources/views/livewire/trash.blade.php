{{-- Trash view sudah ada di components/⚡trash.blade.php --}}
{{-- File ini adalah alias yang digunakan Livewire\Trash component --}}

@php
    // View ini dirender oleh App\Livewire\Trash
    // Layout sudah diset di component: ->layout('components.layouts.app')
@endphp
...
.search-icon { position: absolute; left: 12px; color: #666; pointer-events: none; }
.search-input {
...
.filter-select {
    height: 36px; padding: 0 12px; background: #1a1a1a;
    border: 1px solid #2a2a2a; border-radius: 8px;
    color: #999; font-size: 13px; cursor: pointer; outline: none;
}
.btn-empty-trash {
    display: flex; align-items: center; gap: 6px;
    height: 36px; padding: 0 14px;
    background: rgba(226, 75, 74, 0.1); border: 1px solid rgba(226, 75, 74, 0.3);
    border-radius: 8px; color: #E24B4A; font-size: 13px;
    cursor: pointer; transition: all 0.15s; white-space: nowrap;
}
.btn-empty-trash:hover { background: rgba(226, 75, 74, 0.18); border-color: rgba(226, 75, 74, 0.5); }
.warning-banner {
...
.warning-inner { display: flex; align-items: flex-start; gap: 10px; color: #BA7517; font-size: 13px; line-height: 1.6; }
.warning-inner svg { flex-shrink: 0; margin-top: 2px; }
.warning-inner strong { color: #EF9F27; }
.warning-close { background: none; border: none; color: #666; cursor: pointer; padding: 2px; flex-shrink: 0; transition: color 0.15s; }
...
.page-title { font-size: 22px; font-weight: 500; color: #e8e6e0; margin: 0 0 4px; letter-spacing: -0.3px; }
...
.note-card--urgent { border-color: rgba(226, 75, 74, 0.25); background: rgba(226, 75, 74, 0.03); }
...
.deleted-badge--urgent { color: #E24B4A; background: rgba(226, 75, 74, 0.1); border-color: rgba(226, 75, 74, 0.25); }
.expire-badge {
    font-size: 10px; font-weight: 500; color: #EF9F27;
...
.note-title { font-size: 15px; font-weight: 500; color: #c8c6c0; margin: 0; line-height: 1.4; }
.note-excerpt { font-size: 13px; color: #555; line-height: 1.7; margin: 0; flex: 1; }
.category-badge {
    display: inline-flex; align-items: center; font-size: 11px; padding: 3px 9px; border-radius: 99px;
    background: color-mix(in srgb, var(--cat-color) 15%, transparent);
    border: 1px solid color-mix(in srgb, var(--cat-color) 30%, transparent);
    color: var(--cat-color); width: fit-content;
}
.card-actions { display: flex; gap: 8px; margin-top: 4px; padding-top: 12px; border-top: 1px solid #1e1e1e; }
...
.btn-restore { background: rgba(55, 138, 221, 0.08); border-color: rgba(55, 138, 221, 0.25); color: #378ADD; }
.btn-restore:hover { background: rgba(55, 138, 221, 0.15); border-color: rgba(55, 138, 221, 0.4); }
.btn-delete { background: rgba(226, 75, 74, 0.08); border-color: rgba(226, 75, 74, 0.2); color: #E24B4A; }
.btn-delete:hover { background: rgba(226, 75, 74, 0.15); border-color: rgba(226, 75, 74, 0.35); }
...
.modal {
    ...
    max-width: 400px; width: 90%; display: flex; flex-direction: column; align-items: center; gap: 12px; text-align: center;
}
.modal-icon {
    width: 56px; height: 56px; border-radius: 14px;
    background: rgba(226, 75, 74, 0.1); border: 1px solid rgba(226, 75, 74, 0.25);
    display: flex; align-items: center; justify-content: center; color: #E24B4A; margin-bottom: 4px;
}
.modal-title { font-size: 18px; font-weight: 500; color: #e0ddd8; margin: 0; }
.modal-desc { font-size: 13px; color: #666; line-height: 1.7; margin: 0; }
.modal-desc strong { color: #999; }
.modal-actions { display: flex; gap: 10px; margin-top: 8px; width: 100%; }
.btn-cancel {
    flex: 1; height: 38px; background: #1e1e1e; border: 1px solid #2e2e2e;
    border-radius: 8px; color: #888; font-size: 13px; cursor: pointer; transition: all 0.15s; font-family: inherit;
}
.btn-cancel:hover { border-color: #3e3e3e; color: #aaa; }
.btn-confirm-delete {
    flex: 1; height: 38px; background: #E24B4A; border: 1px solid #E24B4A;
